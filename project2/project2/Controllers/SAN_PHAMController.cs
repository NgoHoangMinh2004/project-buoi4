...
namespace project2.Controllers
{
    public class SAN_PHAMController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaSP,Ten_san_pham,Loai_san_pham,Gia,Mo_ta,Trang_thai")] SAN_PHAM sAN_PHAM)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaSP,Ten_san_pham,Loai_san_pham,Gia,Mo_ta,Trang_thai")] SAN_PHAM sAN_PHAM)
        {
            if (ModelState.IsValid)
            {
