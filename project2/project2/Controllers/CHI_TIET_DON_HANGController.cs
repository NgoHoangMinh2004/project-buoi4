...
namespace project2.Controllers
{
    ...
    {
        private project2_k22cnt3_ngohoangminhEntities db = new project2_k22cnt3_ngohoangminhEntities();
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.MaSP = new SelectList(db.SAN_PHAM, "MaSP", "Ten_san_pham");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "MaCTDH,MaDH,MaSP,So_luong,Thanh_tien")] CHI_TIET_DON_HANG cHI_TIET_DON_HANG)
        {
            ...
            ViewBag.MaSP = new SelectList(db.SAN_PHAM, "MaSP", "Ten_san_pham", cHI_TIET_DON_HANG.MaSP);
            return View(cHI_TIET_DON_HANG);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaCTDH,MaDH,MaSP,So_luong,Thanh_tien")] CHI_TIET_DON_HANG cHI_TIET_DON_HANG)
        {
            if (ModelState.IsValid)
            {
